$(function(){
   var canvasBox=document.querySelector(".canvas-box");
    ...
    $(".aside-list:eq(0) li").click(function(){
        ...
        $(".aside-list:eq(0) li").css("color","black")
...
if(drawObj.history.length==0){
   var flag=false;
    ...
    $(".aside-list:eq(1) li").click(function(){
       var fn=$(this).attr("data-role");
        $(".aside-list:eq(1) li").css("color","black")
        $(this).css("color","chartreuse");
        if(fn=="duobian"){
    ...
    $(".aside-list:eq(2) li").click(function(){
        var fn=$(this).attr("data-role");
        $(".aside-list:eq(2) li").css("color","black")
        $(this).css("color","chartreuse")
            drawObj.style=fn;
            drawObj.draw();
    });
    ...
    $(".aside-list:eq(4) li").click(function(){
        var fn=$(this).attr("data-role");
        $(".aside-list:eq(4) li").css("color","black")
        $(this).css("color","chartreuse")
    ...
    $(".aside-list:eq(5) li").click(function(){
        var xcObj=$(".eraser");
        var fn=$(this).attr("data-role");
        $(".aside-list:eq(5) li").css("color","black")
        $(this).css("color","chartreuse");
    ...
    $(".aside-list:eq(6) li").click(function(){
        ...
        $(".aside-list:eq(6) li").css("color","black")
        $(this).css("color","chartreuse");
